...
| `morphir-gleam-binding` | `morphir-gleam-binding` | `0.2.1` | Compiles Gleam type declarations to IR v3 and v4 with the official Gleam parser and generates Gleam back; incremental. |
