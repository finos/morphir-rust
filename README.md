...
| `morphir-gleam` | `morphir-gleam-binding` | `0.2.1` | Native Gleam frontend and backend using the official Gleam parser; IR v3/v4 types and incremental compilation. |
