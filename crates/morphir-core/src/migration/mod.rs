...
pub use classic_to_v4::{
    ...
    migrate_fqname, migrate_literal, migrate_module_definition, migrate_module_specification,
    migrate_name, migrate_package_specification, migrate_path, migrate_pattern, migrate_type,
