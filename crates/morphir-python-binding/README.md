...
The examples below describe the published `extension/python/v0.3.0` bundle. The earlier
...
`extension/python/v0.3.0` publish the same tested bundle as GitHub release assets.
