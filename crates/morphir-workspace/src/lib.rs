...
pub use diagnostic::{
    ...
    WORKSPACE_PROJECT_NAME_INVALID, WORKSPACE_PROTOCOL_UNSUPPORTED, WORKSPACE_PURPOSE_UNSUPPORTED,
    WORKSPACE_SELECTION_DUPLICATE, WORKSPACE_SELECTION_EMPTY, WORKSPACE_SELECTION_INVALID,
    WORKSPACE_SELECTION_MODULE_COLLISION, WORKSPACE_SELECTION_NAME_REQUIRED,
