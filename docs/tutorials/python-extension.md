...
functions to Morphir IR v3 or v4, and generates Python 3.12 or later code from those definitions.

This checkout also supports IR v3, private modules, and multiple source modules with imports.
