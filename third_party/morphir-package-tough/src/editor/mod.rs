...
pub struct RepositoryEditor {
    ...
    timestamp_version: Option<Version>,
...
impl RepositoryEditor {
    ...
    pub fn snapshot_version(&mut self, snapshot_version: Version) -> &mut Self {
    ...
    pub fn targets_version(&mut self, targets_version: Version) -> Result<&mut Self> {
    ...
    pub fn timestamp_version(&mut self, timestamp_version: Version) -> &mut Self {
    ...
    pub async fn update_delegated_targets(
        ...
        // Make sure the version isn't downgraded
            ...
            error::VersionMismatchSnafu {
                ...
                expected: current_targets.version.clone()
            }
        );
    ...
    fn build_snapshot(
        ...
        let version = self.snapshot_version.clone().context(error::MissingSnafu {
