...
pub enum Error {
    ...
    OlderMetadata {
        role: RoleType,
        current_version: crate::schema::Version,
        new_version: crate::schema::Version,
        backtrace: Backtrace,
    },
    ...
    MissingSnapshotMeta { version: crate::schema::Version },
    ...
    OlderSnapshotInTimestamp {
        snapshot_new: crate::schema::Version,
        timestamp_new: crate::schema::Version,
        snapshot_old: crate::schema::Version,
        timestamp_old: crate::schema::Version,
    },

    /// The snapshot meta must contain targets.json
    #[snafu(display("Snapshot version {} does not contain targets.json", version))]
    SnapshotTargetsMetaMissing { version: crate::schema::Version },
    ...
    SnapshotRoleMissing {
        role: String,
        old_version: crate::schema::Version,
        new_version: crate::schema::Version,
    },
    ...
    SnapshotRoleRollback {
        role: String,
        old_role_version: crate::schema::Version,
        old_snapshot_version: crate::schema::Version,
        new_role_version: crate::schema::Version,
        new_snapshot_version: crate::schema::Version,
    },
    ...
    VersionMismatch {
        role: RoleType,
        fetched: crate::schema::Version,
        expected: crate::schema::Version,
        backtrace: Backtrace,
    },
