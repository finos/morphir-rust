...
fn targets_key_path1() -> PathBuf {
    test_data().join("targetskey-1.pkcs8")
}
...
async fn create_role_flow() {
    ...
    let new_role = TargetsEditor::new("A")
        .version(NonZeroU64::new(1).unwrap().into())
